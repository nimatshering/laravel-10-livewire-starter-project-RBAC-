  ...
  <head>
    ...
    <title>Application for recommendation of Tax Holidays</title>
    <style>
       h2{
         padding: 2px;
         font-size: 18px;
  ...
  <body>
    <h2>Application for recommendation of Tax Holidays</h2>
      <div class="row">
        <div class="column">Application ID: <?php echo $application->app_id; ?></div>
        <div class="column date">Date - <?php echo $application->submitted_at->format('d-M-Y'); ?> </div>
      </div>
       <hr class="divider">
...
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/reports/pdf/taxholiday.blade.php ENDPATH**/ ?>