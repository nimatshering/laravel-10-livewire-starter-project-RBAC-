      ...
      <ol class="inline-flex items-center space-x-1 lg:space-x-3">
        <li class="inline-flex items-center">
          <a href="<?php echo e(route('landing')); ?>" class="text-gray-700 hover:underline inline-flex items-center">
            <span class="font-bold text-xl">Downloads</span>
          </a>
        </li>
      </ol>
    </nav>
  ...
  <section class="relative pt-4 pb-20 min-h-screen">
    <div class="container mx-auto lg:px-10">
      <div class="overflow-hidden mx-auto">
        ...
        <h1 class="font-bold text-xl py-4"><?php echo e($category->name); ?></h1>
          <dl class="py-2">
            <?php $__currentLoopData = $category->downloads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <dd class="mt-1 text-sm text-gray-900 mt-0 col-span-2">
                <ul class="border border-gray-200 rounded-md divide-y divide-gray-200">
                  <li class="pl-3 pr-4 py-2 flex  text-sm hover:bg-gray-100">
                    ...
                    <div class="ml-4 ">
                      <a href="<?php echo e(route('download.documents',  $item->slug)); ?>"  class="flex items-center text-gray-700">
...
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/frontpages/downloads.blade.php ENDPATH**/ ?>