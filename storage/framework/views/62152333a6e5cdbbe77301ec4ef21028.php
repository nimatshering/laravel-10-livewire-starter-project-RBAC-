  ...
  <div x-data="{ open: false }" class="flex flex-col mx-auto lg:items-center lg:justify-between lg:flex-row">
    <div class="flex flex-row items-center justify-between">
      <span class="flex bg-gray-600 hover:bg-gray-500 text-white rounded lg:mr-4">
        <a href="<?php echo e(route('dot.dashboard')); ?>" class="w-full font-bold items-center px-4 py-2 hover:bg-gray-100 hover:text-gray-700 rounded">
      ...
      <nav :class="{'flex': open, 'hidden': !open}" class="lg:flex lg:flex-grow flex-col lg:flex-row pb-4 lg:pb-0">
        ...
        <li>
          <a href="<?php echo e(route('dot.track.application')); ?>" class="w-full font-bold items-center px-4 py-2 hover:bg-gray-100 hover:text-gray-700 rounded">
            Track Application
          </a>
        </li>
        ...
        <!--Feedback-->
        <li>
          <a href="<?php echo e(route('dot.read.feedback')); ?>" class="w-full font-bold items-center px-4 py-2 hover:bg-gray-100 hover:text-gray-700 rounded">
           Read Feedback 
          </a>
        </li>
...
</div><?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/components/custom/dot-nav.blade.php ENDPATH**/ ?>