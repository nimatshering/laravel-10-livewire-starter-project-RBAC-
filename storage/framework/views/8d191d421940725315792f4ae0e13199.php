...
} elseif ($_instance->childHasBeenRendered('l1536975107-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1536975107-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1536975107-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1536975107-0');
} else {
    $response = \Livewire\Livewire::mount('filemanagers', ['appID' => $appID]);
    $html = $response->html();
    $_instance->logRenderedChild('l1536975107-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/agency/module1/locallymanufacturedmaterial/supporting-documents.blade.php ENDPATH**/ ?>