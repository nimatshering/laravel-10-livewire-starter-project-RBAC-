<div>
  <div class="container py-4 mx-auto">
     <?php echo $__env->make('livewire.agency.module1.valueaddition-certificate.partials._breadcrumbs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <div class="mt-4 py-6 w-full rounded bg-gray-50 text-gray-700 border border-gray-200">
        <div class="flex">
          <div class="w-4/12">
            ...
            <div class="text-sm text-center text-gray-500">Step 1: Busines Information</div>
          </div>
          ...
          <div class="w-4/12">
            ...
            <div class="text-sm font-bold text-center text-gray-800">Step 2: Upload Supporting Documents</div>
          </div>
        ...
        <div class="flex flex-col">
            <div class="align-middle inline-block min-w-full">
              <div class="my-6 px-8 pb-6 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                <h1 class="bg-gray-500 font-bold p-2 rounded text-white mt-6">Upload Supporting Documents</h1>
                  ...
                  <div class="my-6">
                    <p class="p-2">1. Copy of invoice & Copy of Import License under attachment</p>
                    <p class="p-2">2. Raw Material Requirement (RM Form 1) </p>
                    <p class="p-2">3. Raw Material Utilization Form (RM Form 2)</p>
                    <p class="p-2">4. Undertaking form</p>
                  </div> 

                   <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('filemanagers', ['appID' => $appID])->html();
} elseif ($_instance->childHasBeenRendered('l1155953834-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1155953834-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1155953834-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1155953834-0');
} else {
    $response = \Livewire\Livewire::mount('filemanagers', ['appID' => $appID]);
    $html = $response->html();
    $_instance->logRenderedChild('l1155953834-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

                <div class="flex justify-end mt-6 gap-4">
                  <a href="<?php echo e(route('doi.review.value.added.certificate', $appID)); ?>" class="btn-blue">
...
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/agency/module1/valueaddition-certificate/additional-details.blade.php ENDPATH**/ ?>