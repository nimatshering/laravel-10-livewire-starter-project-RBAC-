      ...
      <div class="w-full mx-auto">
        ...
        <div class="container mx-auto">
          <div class="grid grid-cols-1 gap-6 px-2 sm:grid-cols-3 lg:grid-cols-3  lg:px-10">
              ...
              <!--  Dzongkhag & Gewogs-->
            <a href="<?php echo e(route('admin.dzongkhags')); ?>" class="dashboard-button">
              <div class="p-2 text-white bg-sky-600 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75Z" />
                </svg>
              </div>
              <span class="text-cyan-800  font-bold"> Dzongkhag & Gewogs</span>
            </a>
...
<?php endif; ?>
<?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/livewire/admin/dashboard.blade.php ENDPATH**/ ?>