      ...
      <ol class="inline-flex items-center space-x-1 lg:space-x-2">
        <li class="inline-flex items-center">
          <a href="<?php echo e(route('landing')); ?>" class="text-gray-700 hover:underline inline-flex items-center">
            <span class="font-bold text-xl">Legislations</span>
          </a>
        </li>
      </ol>
    </nav>
              ...
              <dd class="mt-1 text-sm text-gray-900 col-span-2">
                <ul class="border border-gray-200 rounded-md divide-y divide-gray-200">
                  <li class="pl-3 pr-4 py-2 flex  text-sm hover:bg-gray-100">
                    ...
                    <div class="ml-4 ">
                      <a href="<?php echo e(route('download.legislations',  $item->slug)); ?>"  class="flex items-center text-gray-700">
...
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/frontpages/legislations.blade.php ENDPATH**/ ?>