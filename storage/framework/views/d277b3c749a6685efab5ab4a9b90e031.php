...
<div class="my-2">
    <section class="mt-10">
      ...
      <!-- Add/Edit Modal -->
      <?php echo $__env->make('livewire.business.module1.guest-visa.partials._addguest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <!--Delete Modal -->
      <?php echo $__env->make('livewire.business.module1.guest-visa.partials._delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section> 
</div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/business/module1/guest-visa/guestlists.blade.php ENDPATH**/ ?>