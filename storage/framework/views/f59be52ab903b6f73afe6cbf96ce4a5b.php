...
<?php endif; ?>
    ...
    <div class="flex flex-col lg:flex-row mt-6 gap-2">
      <div class="w-full lg:flex-grow -mx-4 -my-2 overflow-x-auto lg:-mx-8">
            ...
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  ...
                  <th class="py-3 text-sm text-left text-gray-500">
                      Status
                  </th>
                  <th class="pr-7 py-2 text-sm text-right text-gray-500">View
                  </th>
                </tr>
              </thead>
...
<?php endif; ?><?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/business/business-dashboard.blade.php ENDPATH**/ ?>