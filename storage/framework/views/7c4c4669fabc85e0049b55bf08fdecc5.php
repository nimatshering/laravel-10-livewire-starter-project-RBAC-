<div>
  <div class="container py-4 mx-auto">
    <?php echo $__env->make('livewire.business.module1.taxholiday.partials._breadcrumbs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

      <!-- Stepper-->
         <?php echo $__env->make('livewire.business.module1.taxholiday.partials._step2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
} elseif ($_instance->childHasBeenRendered('l3679570749-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3679570749-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3679570749-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3679570749-0');
} else {
    $response = \Livewire\Livewire::mount('filemanagers', ['appID' => $appID]);
    $html = $response->html();
    $_instance->logRenderedChild('l3679570749-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/business/module1/taxholiday/supporting-doc.blade.php ENDPATH**/ ?>