...
<?php endif; ?>
    <section class="mt-4 mb-10 shadow rounded py-4">
        <?php echo $__env->make('livewire.business.products.partials._step1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('livewire.business.products.partials._form1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section> 
</div><?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/livewire/business/products/product-certifications.blade.php ENDPATH**/ ?>