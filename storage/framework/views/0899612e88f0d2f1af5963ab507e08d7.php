          ...
          <div class="flex flex-col lg:flex-row gap-2 justify-end">
              <div class="flex flex-row gap-2 justify-evenly">
                ...
                <dt class="text-sm font-semibold text-gray-500">
                  <a href="<?php echo e(route('doi.edit.investmentallowance', $application->id)); ?>"
                    class="btn-outline">
                    Edit
                  </a>
                </dt>
...
<?php endif; ?>
               ...
               <dt class="text-sm font-semibold text-gray-500 text-right">
                ...
                <dt class="text-sm font-semibold text-gray-500 text-right">
                  <a href="<?php echo e(route('doi.investmentallowance.pdf', $application->id)); ?>"
                      class="btn-gray"
                      target="_blank">
         ...
         <div class="border-t border-gray-200">
           <dl>
            ...
            <?php if(isset($application->cidnumber)): ?>
            <div class="px-4 py-3 grid grid-cols-3 gap-4">
              <dt class="text-sm font-semibold text-gray-500">
                Citizenship ID
              </dt>
            ...
            <?php if(isset($application->email)): ?>
            <div class="bg-gray-50 px-4 py-3 grid grid-cols-3 gap-4">
              <dt class="text-sm font-semibold text-gray-500">
                Email 
              </dt>
        ...
        <?php echo $__env->make('livewire.agency.module1.investmentallowance.partials._approve', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('livewire.agency.module1.investmentallowance.partials._resubmit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('livewire.agency.module1.investmentallowance.partials._reject', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section>  
  </div>
</div>
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/agency/module1/investmentallowance/review-application.blade.php ENDPATH**/ ?>