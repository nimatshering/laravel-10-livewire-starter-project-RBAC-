      ...
      <ol class="inline-flex items-center space-x-1 lg:space-x-3">
        <li class="inline-flex items-center">
          ...
          <a href="<?php echo e(route('dot.dashboard')); ?>" class="text-gray-700 hover:underline inline-flex items-center">
            ...
            <span class="font-bold ml-4"> Application for Made in Bhutan</span>
          </a>
        </li>
      </ol>
    </nav><?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/agency/module1/brand-bhutan/madeinbhutan/partials/_breadcrumbs.blade.php ENDPATH**/ ?>