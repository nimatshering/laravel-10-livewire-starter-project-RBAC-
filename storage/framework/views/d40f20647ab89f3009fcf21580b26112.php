...
} elseif ($_instance->childHasBeenRendered('l999518543-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l999518543-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l999518543-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l999518543-0');
} else {
    $response = \Livewire\Livewire::mount('business.products.topmanagements', ['appID' => $this->appID, 'review' => false]);
    $html = $response->html();
    $_instance->logRenderedChild('l999518543-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l999518543-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l999518543-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l999518543-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l999518543-1');
} else {
    $response = \Livewire\Livewire::mount('business.products.techmanagements', ['appID' => $this->appID, 'review' => false]);
    $html = $response->html();
    $_instance->logRenderedChild('l999518543-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l999518543-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l999518543-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l999518543-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l999518543-2');
} else {
    $response = \Livewire\Livewire::mount('business.products.productcertdetails', ['appID' => $this->appID, 'review' => false]);
    $html = $response->html();
    $_instance->logRenderedChild('l999518543-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l999518543-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l999518543-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l999518543-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l999518543-3');
} else {
    $response = \Livewire\Livewire::mount('filemanagers', ['appID' => $appID]);
    $html = $response->html();
    $_instance->logRenderedChild('l999518543-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/livewire/agency/products/partials/_form2.blade.php ENDPATH**/ ?>