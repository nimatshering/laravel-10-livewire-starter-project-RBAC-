<div class="p-2 lg:mx-4">
    <nav class="flex justify-between bg-gray-100 p-3 rounded font-sans w-full my-4">
      <ol class="list-reset flex text-grey-dark">
        <li><a href="<?php echo e(route('admin.dashboard')); ?>" class="text-blue font-bold">Home</a></li>
        <li><span class="mx-2">/</span></li>
        <li><a href="<?php echo e(route('admin.divisions')); ?>" class="text-blue font-bold">Divisions</a></li>
        <li><span class="mx-2">/</span></li>
        <?php if(isset($this->division_id)): ?>
          <li><?php echo e(App\Models\Division::find($this->division_id)->name); ?></li>
          <li><span class="mx-2">/</span></li>
        <?php endif; ?>
        <li>Applications</li>
      </ol>
...
<?php endif; ?>
    <div class="mt-4">
        ...
        <table class="min-w-full divide-y divide-gray-200 table-auto">
            <thead class="bg-gray-100">
              <tr class="text-gray-800 text-xs font-semibold uppercase">
                ...
                <th scope="col" class="px-6 py-4 text-right tracking-wider"></th>
              </tr>
            </thead>
            <tbody class="bg-white divide-y divide-gray-200">
              <?php $__currentLoopData = $modelnames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="my-6">
        <?php echo e($modelnames->links()); ?>

      </div>
      <!-- Add/Edit Modal -->
      <?php echo $__env->make('livewire.admin.modelnames.partials._add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!--Delete Modal -->
      
    </div>
</div><?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/livewire/admin/modelnames/index.blade.php ENDPATH**/ ?>