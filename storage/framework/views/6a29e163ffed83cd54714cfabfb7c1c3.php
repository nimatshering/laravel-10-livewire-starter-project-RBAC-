...
<div class="pb-10 mb-10">
    <?php echo $__env->make('livewire.business.module1.guest-visa.partials._breadcrumbs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('livewire.business.module1.guest-visa.partials._step2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      

     <!-- Guest Details -->
     <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('business.module1.guest-visa.guestlists', ['appID' => $appID, 'reviewFlag' => true])->html();
} elseif ($_instance->childHasBeenRendered('l2699832042-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2699832042-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2699832042-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2699832042-0');
} else {
    $response = \Livewire\Livewire::mount('business.module1.guest-visa.guestlists', ['appID' => $appID, 'reviewFlag' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('l2699832042-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
    ...
    <!-- Previous Visit -->
     <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('business.module1.guest-visa.guest-visits', ['appID' => $appID, 'reviewFlag' => true])->html();
} elseif ($_instance->childHasBeenRendered('l2699832042-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2699832042-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2699832042-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2699832042-1');
} else {
    $response = \Livewire\Livewire::mount('business.module1.guest-visa.guest-visits', ['appID' => $appID, 'reviewFlag' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('l2699832042-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
...
} elseif ($_instance->childHasBeenRendered('l2699832042-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2699832042-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2699832042-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2699832042-2');
} else {
    $response = \Livewire\Livewire::mount('filemanagers', ['appID' => $appID]);
    $html = $response->html();
    $_instance->logRenderedChild('l2699832042-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
      ...
      <div class="bg-gray-100 rounded p-2">
        ...
        <span class="flex items-center py-3 justify-end gap-4">
          <span>I agree</span>
     ...
     <?php echo $__env->make('livewire.business.module1.guest-visa.partials._submit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>

<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/business/module1/guest-visa/guest-details.blade.php ENDPATH**/ ?>