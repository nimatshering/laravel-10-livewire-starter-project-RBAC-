...
<div class="mb-10 pb-2">
    <section class="mt-10 ">
        <h1 class="font-bold py-2 text-sm">Name & Date of previous visit of any business guest(s) invited within this calendar year.</h1>
        ...
        <table class="min-w-full divide-y divide-gray-200 table-auto">
              ...
              <?php if($reviewFlag == true): ?>
                <th scope="col" class="text-right tracking-wider py-4 px-2">
                    <button wire:click="$toggle('confirmItemAdd')" class="btn-gray">
                      <i class="fa fa-plus-circle text-white"></i> ADD Visit
                    </button>
                </th>
              <?php endif; ?>
            </tr>
          ...
          <tbody class="divide-y divide-gray-200">
            <?php $__currentLoopData = $guestvisits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index =>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="hover:bg-gray-50">
              ...
              <td class="p-2">
                <div class="text-sm"><?php echo e($item->visit_at); ?></div>
              </td>

              <td class="p-2">
                <div class="text-sm"><?php echo e($item->depart_at); ?></div>
              </td>
      ...
      <!-- Add/Edit Modal -->
      <?php echo $__env->make('livewire.business.module1.guest-visa.partials._addvisit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <!--Delete Modal -->
      <?php echo $__env->make('livewire.business.module1.guest-visa.partials._deletevisit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section> 
</div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/business/module1/guest-visa/guest-visits.blade.php ENDPATH**/ ?>