...
<?php if(session()->has('message')): ?>
    <div class="flex w-full max-w-md mx-auto overflow-hidden bg-gray-50 rounded-lg shadow-md mt-4">
        ...
        <div class="px-4 py-2 -mx-3">
            <div class="mx-3">
                <p class="text-sm text-gray-800"> <?php echo session()->get('message'); ?></p>
            </div>
        </div>
    </div>
<?php endif; ?>
    ...
    <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-gray-50 rounded-lg shadow-md mt-4">
        ...
        <div class="px-4 py-2 -mx-3">
            <div class="mx-3">
                ...
                <p class="text-sm text-gray-800"> <?php echo session()->get('warning'); ?></p>
            </div>
        </div>
    </div>
<?php endif; ?>
    ...
    <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-gray-50 rounded-lg shadow-md mt-4">
        ...
        <div class="px-4 py-2 -mx-3">
            <div class="mx-3">
                ...
                <p class="text-sm text-gray-800"> <?php echo session()->get('error'); ?></p>
            </div>
        </div>
    </div>
<?php endif; ?>
...
<?php /**PATH /Users/nimatshering/Sites/laravel-10-starter-project/resources/views/components/custom/utilities/messages.blade.php ENDPATH**/ ?>