      ...
      <ol class="inline-flex items-center space-x-1 lg:space-x-3">
        ...
        <li class="inline-flex items-center">
          <div class="text-gray-700 inline-flex items-center">
            ...
            <span class="ml-4"> Approval letter to Department of Immigration</span>
          </div>
        </li>
      </ol>
    </nav><?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/agency/module1/guest-visa/approval-letter/partials/_breadcrumbs.blade.php ENDPATH**/ ?>