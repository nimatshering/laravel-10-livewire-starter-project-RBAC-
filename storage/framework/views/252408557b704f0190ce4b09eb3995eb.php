<?php if (isset($component)) { $__componentOriginal466b6a426e4a24380cecdc4480c9c205 = $component; } ?>
<?php $component = App\View\Components\DoiLayout::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('doi-layout'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\DoiLayout::class))->getConstructor()): ?>
...
<?php endif; ?>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-2 whitespace-nowrap">
                    <div class="flex items-center">
                      <div class="font-medium text-gray-800">
                        <?php if(isset($item->submitted_at)): ?>
                           <?php echo e(date('d-M-Y', strtotime($item->submitted_at))); ?>
                  ...
                  <td class="p-2 text-sm whitespace-nowrap flex justify-end text-blue-600">
                    <a href="<?php echo e(route('doi.'.$item->route, $item->app_id)); ?>" class="mr-4">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
 ...
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal466b6a426e4a24380cecdc4480c9c205)): ?>
<?php $component = $__componentOriginal466b6a426e4a24380cecdc4480c9c205; ?>
<?php unset($__componentOriginal466b6a426e4a24380cecdc4480c9c205); ?>
<?php endif; ?><?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/agency/doi-dashboard.blade.php ENDPATH**/ ?>