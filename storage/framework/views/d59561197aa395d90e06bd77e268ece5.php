  ...
  <nav class="flex bg-stone-200 text-gray-700 border border-gray-200 py-3 px-5 rounded-lg" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 lg:space-x-3">
      <li class="inline-flex items-center">
        <a href="<?php echo e(route('bsb.dashboard')); ?>" class="text-gray-700 font-bold hover:underline inline-flex items-center">
...
<?php endif; ?>
  ...
  <?php endif; ?>
</div><?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/livewire/track-application.blade.php ENDPATH**/ ?>