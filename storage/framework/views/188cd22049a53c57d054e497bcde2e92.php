    ...
    <script src="<?php echo e(asset('js/swiper/swiper-bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/purecounter/purecounter_vanilla.js')); ?>"></script>
    <script src="<?php echo e(asset('js/glightbox/js/glightbox.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/aos/aos.js')); ?>"></script>
   ...
   <?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/layouts/partials/_scripts.blade.php ENDPATH**/ ?>