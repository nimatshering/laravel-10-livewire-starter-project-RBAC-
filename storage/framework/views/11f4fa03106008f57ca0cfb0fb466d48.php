...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom.utilities.modals.open-button','data' => ['btntext' => 'edit','btncolor' => 'blue']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['btntext' => 'edit','btncolor' => 'blue']); ?>
      ...
      <div class="h-auto w-full mx-2 text-left bg-white rounded-lg shadow-xl lg:max-w-2xl lg:mx-0" @click.away="open = false">
        <div class="flex justify-between bg-gray-50 rounded-lg">
          <div class="flex justify-between items-center px-6 py-4">
            <p class="text-xl font-bold">Edit - Registered Users</p>
          </div>
            <!-- Modal close button  -->
...
<?php endif; ?>
        ...
        <div class="px-6 py-4">
          <form method="POST" action="<?php echo e(route('admin.registered.user.update',$user->id)); ?>">
            <?php echo method_field('PATCH'); ?>
            <?php echo $__env->make('livewire.admin.registered-users.partials._form',['create'=>'false'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          </form>
        </div>
      </div>
    </div>
  </div>
</div><?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/livewire/admin/registered-users/partials/_edit-modal-dialog.blade.php ENDPATH**/ ?>