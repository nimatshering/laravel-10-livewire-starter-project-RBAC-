<div class="container py-4 mx-auto">
     <?php echo $__env->make('livewire.admin.registered-users.partials._breadcrumbs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--Session message -->
    ...
    <div class="mx-auto mt-6">
      <div class="flex flex-col">
        <div class="my-2 overflow-x-auto sm:mx-6 lg:mx-8">
         ...
         <!--Delete Modal -->
        <!-- Add/Edit Modal -->
        <?php echo $__env->make('livewire.admin.registered-users.partials._add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         <!--Delete Modal -->
        <?php echo $__env->make('livewire.admin.registered-users.partials._delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>

<?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/livewire/admin/registered-users/index.blade.php ENDPATH**/ ?>