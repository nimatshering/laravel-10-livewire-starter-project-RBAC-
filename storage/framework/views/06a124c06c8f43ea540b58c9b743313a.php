...
<?php endif; ?>
    <div class="container mx-auto ">
      <div class="flex flex-col mb-10 ">
        ...
        <!-- Add/Edit Modal -->
        <?php echo $__env->make('livewire.admin.links.partials._add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         <!--Delete Modal -->
        <?php echo $__env->make('livewire.admin.links.partials._delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>

<?php /**PATH /Users/nimatshering/Sites/laravel-10-starter-project/resources/views/livewire/admin/links/index.blade.php ENDPATH**/ ?>