<div class="p-2 lg:mx-4">
        <?php echo $__env->make('livewire.admin.dzongkhag.partials._breadcrumbs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--Session message -->
...
<?php endif; ?>
    <div class="mt-4">
      <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
        <table class="min-w-full divide-y divide-gray-200 table-auto">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <?php $__currentLoopData = $dzongkhags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="hover:bg-gray-50">
              ...
              <td class="px-6 py-1">
                <div class="flex text-sm text-gray-900 justify-center">
                  <a href="<?php echo e(route('admin.gewogs', $item->id)); ?>" class="btn-gray-sm px-4">
                    <i class="fa fa-tags mr-2"></i>
                      <?php echo $item->gewogs->count(); ?>
      ...
      <div class="my-4">
        <?php echo e($dzongkhags->links()); ?>

      </div>
      <!-- Add/Edit Modal -->
      <?php echo $__env->make('livewire.admin.dzongkhag.partials._add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!--Delete Modal -->
      <?php echo $__env->make('livewire.admin.dzongkhag.partials._delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>

<?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/livewire/admin/dzongkhag/index.blade.php ENDPATH**/ ?>