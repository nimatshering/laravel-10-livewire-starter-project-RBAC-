<div>
  <div class="container py-4 mx-auto">
    <?php echo $__env->make('livewire.business.module1.investmentallowance.partials._breadcrumbs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

      <!-- Stepper-->
         <?php echo $__env->make('livewire.business.module1.investmentallowance.partials._step2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
} elseif ($_instance->childHasBeenRendered('l2944271694-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2944271694-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2944271694-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2944271694-0');
} else {
    $response = \Livewire\Livewire::mount('filemanagers', ['appID' => $appID]);
    $html = $response->html();
    $_instance->logRenderedChild('l2944271694-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/business/module1/investmentallowance/supporting-doc.blade.php ENDPATH**/ ?>