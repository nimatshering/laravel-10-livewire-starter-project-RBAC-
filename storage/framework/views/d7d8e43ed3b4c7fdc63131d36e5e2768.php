             ...
             <!-- buttons -->
              <div class="flex flex-row gap-2 justify-evenly">
                <dt class="text-sm font-semibold text-gray-500">
                  <a href="<?php echo e(route('doi.edit.locally.manufactured.material', $application->id)); ?>"
                    class="btn-outline">
                    Edit
                  </a>
                </dt>
...
<?php endif; ?>
                ...
                <dt class="text-sm font-semibold text-gray-500 text-right">
                  <a href="<?php echo e(route('doi.locally.manufactured.material.pdf', $application->app_id)); ?>"
                      class="btn-gray"
                      target="_blank">
...
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/agency/module1/locallymanufacturedmaterial/review-application.blade.php ENDPATH**/ ?>