  <div class="container py-4 mx-auto mb-20">
       <?php echo $__env->make('livewire.business.products.partials._breadcrumbs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
} elseif ($_instance->childHasBeenRendered('l86967810-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l86967810-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l86967810-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l86967810-0');
} else {
    $response = \Livewire\Livewire::mount('business.products.topmanagements', ['appID' => $this->appID, 'review' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('l86967810-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l86967810-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l86967810-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l86967810-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l86967810-1');
} else {
    $response = \Livewire\Livewire::mount('business.products.techmanagements', ['appID' => $this->appID, 'review' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('l86967810-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l86967810-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l86967810-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l86967810-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l86967810-2');
} else {
    $response = \Livewire\Livewire::mount('business.products.productcertdetails', ['appID' => $this->appID, 'review' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('l86967810-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
      ...
      <?php echo $__env->make('livewire.business.products.partials._submit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section>  
  </div>
<?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/livewire/business/products/review-application.blade.php ENDPATH**/ ?>