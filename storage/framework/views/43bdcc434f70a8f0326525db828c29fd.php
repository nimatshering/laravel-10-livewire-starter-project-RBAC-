<div class="container py-4 mx-auto">
     <?php echo $__env->make('livewire.admin.users.partials._breadcrumbs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--Session message -->
...
<?php endif; ?>
    ...
    <div class="mx-auto mt-6">
      <div class="flex flex-col">
        ...
        <!-- Add/Edit Modal -->
        <?php echo $__env->make('livewire.admin.users.partials._add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         <!--Delete Modal -->
        <?php echo $__env->make('livewire.admin.users.partials._delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>

<?php /**PATH /Users/nimatshering/Sites/laravel-10-starter-project/resources/views/livewire/admin/users/index.blade.php ENDPATH**/ ?>