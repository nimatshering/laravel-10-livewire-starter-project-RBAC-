  ...
  <footer id="footer" class="bg-sky-800 text-white">
    ...
    <div class="container mx-auto text-center pb-10">
       <div class="text-gray-100">
          © <?php echo e(date('Y')); ?> Zhibsel Consulting,Thimphu, Bhutan 
        </div>
      <div class="text-sm text-gray-100">
          <a href="<?php echo e(route('landing')); ?>">www.zca-lab.com </a>.
      </div>
    </div>
  </footer>
<?php /**PATH /Users/nimatshering/Sites/laravel-10-starter-project/resources/views/components/custom/footer.blade.php ENDPATH**/ ?>