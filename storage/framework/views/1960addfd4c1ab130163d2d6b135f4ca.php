...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom.utilities.modals.open-button','data' => ['btntext' => 'Add New User','btncolor' => 'gray']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['btntext' => 'Add New User','btncolor' => 'gray']); ?>
...
<?php endif; ?>
        ...
        <div class="px-6 py-4">
         <form method="POST" action="<?php echo e(route('admin.users.store')); ?>">
            <?php echo $__env->make('livewire.admin.users.partials._form',['create'=>'true'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </form>
        </div>
      </div>
    </div>
  </div>
</div><?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/livewire/admin/users/partials/_add-modal-dialog.blade.php ENDPATH**/ ?>