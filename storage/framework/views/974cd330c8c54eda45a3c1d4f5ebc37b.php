...
<div class="mb-10 pb-2">
    <section class="mt-10 ">
      ...
      <!-- Add/Edit Modal -->
      <?php echo $__env->make('livewire.agency.module1.guest-visa.partials._addvisit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <!--Delete Modal -->
      <?php echo $__env->make('livewire.agency.module1.guest-visa.partials._deletevisit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section> 
</div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/agency/module1/guest-visa/doi-guest-visits.blade.php ENDPATH**/ ?>