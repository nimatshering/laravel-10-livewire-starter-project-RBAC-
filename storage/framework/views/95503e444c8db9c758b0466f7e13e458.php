          ...
          <div class="flex flex-col lg:flex-row gap-2 justify-end">
              <div class="flex flex-row gap-2 justify-evenly">
                ...
                <dt class="text-sm font-semibold text-gray-500">
                  <a href="<?php echo e(route('doi.edit.taxholiday', $application->id)); ?>"
                    class="btn-outline">
                    Edit
                  </a>
                </dt>
...
<?php endif; ?>
               ...
               <dt class="text-sm font-semibold text-gray-500 text-right">
                ...
                <dt class="text-sm font-semibold text-gray-500 text-right">
                  ...
                  <?php endif; ?> 
                <dt class="text-sm font-semibold text-gray-500 text-right">
                  <a href="<?php echo e(route('doi.taxholiday.pdf', $application->id)); ?>"
                      class="btn-gray"
                      target="_blank">
        ...
        <?php echo $__env->make('livewire.agency.module1.taxholiday.partials._approve', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('livewire.agency.module1.taxholiday.partials._resubmit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('livewire.agency.module1.taxholiday.partials._reject', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section>  
  </div>
</div>
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/agency/module1/taxholiday/review-application.blade.php ENDPATH**/ ?>