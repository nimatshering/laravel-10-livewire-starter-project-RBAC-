            ...
            <?php if($application->status == 'Resubmit' || $application->status == 'Draft'): ?>
              <div class="flex flex-col lg:flex-row gap-2 justify-end">
                <dt class="text-sm font-semibold text-gray-500">
                  <a href="<?php echo e(route('business.edit.value.added.certificate', $application->id)); ?>"
                    class="btn-outline">
                    Edit
                  </a>
                </dt>
...
<?php endif; ?>
        ...
        <div class="border-t border-gray-200">
            <dl>
              ...
              <div class="bg-gray-50 px-4 py-3 grid grid-cols-3 gap-4">
                ...
                <dd class="mt-1 text-sm text-gray-900 col-span-2"><?php echo e($application->promoter); ?></dd>
              </div>

              <div class="px-4 py-3 grid grid-cols-3 gap-4">
                <dt class="text-sm font-semibold text-gray-500">Business Licence</dt>
                <dd class="mt-1 text-sm text-gray-900 col-span-2"><?php echo e($application->licenseno); ?></dd>
              </div>

              <?php if(isset($application->cid)): ?>
                <div class="px-4 py-3 grid grid-cols-3 gap-4">
                  <dt class="text-sm font-semibold text-gray-500">CID</dt>
                  <dd class="mt-1 text-sm text-gray-900 col-span-2"><?php echo e($application->cid); ?></dd>
                </div>
              <?php endif; ?>
              ...
              <div class="bg-gray-50 px-4 py-3 grid grid-cols-3 gap-4">
                ...
                <dd class="mt-1 text-sm text-gray-900 col-span-2"><?php echo e($application->businessname); ?></dd>
              </div>
            ...
            <div class="bg-gray-50 px-4 py-3 grid grid-cols-3 gap-4">
              ...
              <dd class="mt-1 text-sm text-gray-900 col-span-2"><?php echo e($application->activity); ?></dd>
            </div>
            ...
            <div class="px-4 py-3 grid grid-cols-3 gap-4">
              ...
              <dd class="mt-1 text-sm text-gray-900 col-span-2"><?php echo e($application->location); ?></dd>
            </div>
              ...
              <div class="bg-gray-50 px-4 py-3 grid grid-cols-3 gap-4">
                ...
                <dd class="mt-1 text-sm text-gray-900 col-span-2"><?php echo e($application->email); ?></dd>
              </div>

              <div class="px-4 py-3 grid grid-cols-3 gap-4">
                <dt class="text-sm font-semibold text-gray-500"> Value Addition</dt>
                  <dd class="mt-1 text-sm text-gray-900 col-span-2">
                    <?php echo e($application->value_addition); ?>
      ...
      <?php echo $__env->make('livewire.business.module1.valueaddition-certificate.partials._submit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section>  
  </div>
</div>
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/business/module1/valueaddition-certificate/review-application.blade.php ENDPATH**/ ?>