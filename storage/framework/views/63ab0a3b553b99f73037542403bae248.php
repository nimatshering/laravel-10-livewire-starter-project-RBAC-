      ...
      <div class="w-full mx-auto">
        ...
        <div class="container mx-auto">
          <div class="grid grid-cols-1 gap-6 px-2 sm:grid-cols-3 lg:grid-cols-3  lg:px-10">
              ...
              <!-- Address-->
            <a href="<?php echo e(route('admin.address')); ?>" class="dashboard-button">
             ...
             <!-- Manage Useful Links-->
            <a href="<?php echo e(route('admin.usefullinks')); ?>" class="dashboard-button">
              <div class="p-2 text-white bg-sky-600 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<?php endif; ?>
<?php /**PATH /Users/nimatshering/Sites/laravel-10-starter-project/resources/views/livewire/admin/dashboard.blade.php ENDPATH**/ ?>