          ...
          <?php if($application->status == 'Resubmit' || $application->status == 'Draft'): ?>
            <div class="flex flex-col lg:flex-row gap-2 justify-end">
              <dt class="text-sm font-semibold text-gray-500">
                <a href="<?php echo e(route('business.edit.investmentallowance', $application->id)); ?>"
                  class="btn-outline">
                  Edit
                </a>
              </dt>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('livewire.business.module1.investmentallowance.partials._submit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section>  
  </div>
</div>
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/business/module1/investmentallowance/review-application.blade.php ENDPATH**/ ?>