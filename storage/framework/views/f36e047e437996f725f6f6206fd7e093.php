...
<?php endif; ?>
    <section class="mt-4 mb-10 shadow rounded py-4">
        <?php echo $__env->make('livewire.agency.module1.guest-visa.partials._step1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('livewire.agency.module1.guest-visa.partials._form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section> 
</div>
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/agency/module1/guest-visa/index.blade.php ENDPATH**/ ?>