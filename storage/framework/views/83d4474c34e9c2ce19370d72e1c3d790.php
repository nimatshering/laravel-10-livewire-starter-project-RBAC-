  ...
  <?php $__env->startPush('styles'); ?>
    ...
    <div class="py-5 bg-white lg:p-6">
      ...
      <h1 class="my-2 lg:mt-6 font-bold">9. Top management</h1>
          <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('business.products.topmanagements', ['appID' => $this->appID, 'review' => false])->html();
} elseif ($_instance->childHasBeenRendered('l2150402448-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2150402448-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2150402448-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2150402448-0');
} else {
    $response = \Livewire\Livewire::mount('business.products.topmanagements', ['appID' => $this->appID, 'review' => false]);
    $html = $response->html();
    $_instance->logRenderedChild('l2150402448-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
          ...
          <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('business.products.techmanagements', ['appID' => $this->appID, 'review' => false])->html();
} elseif ($_instance->childHasBeenRendered('l2150402448-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2150402448-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2150402448-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2150402448-1');
} else {
    $response = \Livewire\Livewire::mount('business.products.techmanagements', ['appID' => $this->appID, 'review' => false]);
    $html = $response->html();
    $_instance->logRenderedChild('l2150402448-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
          ...
          <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('business.products.productcertdetails', ['appID' => $this->appID, 'review' => false])->html();
} elseif ($_instance->childHasBeenRendered('l2150402448-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2150402448-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2150402448-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2150402448-2');
} else {
    $response = \Livewire\Livewire::mount('business.products.productcertdetails', ['appID' => $this->appID, 'review' => false]);
    $html = $response->html();
    $_instance->logRenderedChild('l2150402448-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l2150402448-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l2150402448-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2150402448-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2150402448-3');
} else {
    $response = \Livewire\Livewire::mount('filemanagers', ['appID' => $appID]);
    $html = $response->html();
    $_instance->logRenderedChild('l2150402448-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php /**PATH /Users/nimatshering/Sites/pmas-v1.0/resources/views/livewire/business/products/partials/_form2.blade.php ENDPATH**/ ?>