  ...
  <nav class="flex bg-stone-100 text-gray-700 border border-gray-200 py-3 px-5 rounded-lg" aria-label="Breadcrumb">
      <ol class="inline-flex items-center space-x-1 lg:space-x-3">
        <li class="inline-flex items-center">
          <a href="<?php echo e(route('business.dashboard')); ?>" class="text-gray-700 hover:underline inline-flex items-center">
          ...
          <a href="<?php echo e(route('business.dashboard')); ?>" class="text-gray-700 hover:underline inline-flex items-center">
            ...
            <span class="font-bold ml-4">Business Guest Visa Application</span>
          </a>
        </li>

        <li class="inline-flex items-center">
          <a href="<?php echo e(route('business.dashboard')); ?>" class="text-gray-700 inline-flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
            </svg>
            <span class="ml-4">Business Guest Visa</span>
          </a>
        </li>
      </ol>
    </nav>
              ...
              <?php if($application->status == 'Resubmit' || $application->status == 'Draft'): ?>
                <div class="flex flex-col lg:flex-row gap-2 justify-end">
                  <dt class="text-sm font-semibold text-gray-500">
                    <a href="<?php echo e(route('business.edit.guestvisa', $application->id)); ?>"
                      class="btn-outline">
                      Edit
                    </a>
                  </dt>
        ...
        <div class="border-t border-gray-200">
          <dl>
            ...
            <div class="p-2">
              ...
              <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('business.module1.guest-visa.guestlists', ['appID' => $appID, 'reviewFlag'=>false])->html();
} elseif ($_instance->childHasBeenRendered('l1347499049-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1347499049-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1347499049-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1347499049-0');
} else {
    $response = \Livewire\Livewire::mount('business.module1.guest-visa.guestlists', ['appID' => $appID, 'reviewFlag'=>false]);
    $html = $response->html();
    $_instance->logRenderedChild('l1347499049-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
                <!-- Guest visits -->
              <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('business.module1.guest-visa.guest-visits', ['appID' => $appID, 'reviewFlag'=>false])->html();
} elseif ($_instance->childHasBeenRendered('l1347499049-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1347499049-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1347499049-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1347499049-1');
} else {
    $response = \Livewire\Livewire::mount('business.module1.guest-visa.guest-visits', ['appID' => $appID, 'reviewFlag'=>false]);
    $html = $response->html();
    $_instance->logRenderedChild('l1347499049-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
            </div>
...
<?php /**PATH /Users/nimatshering/Sites/bds-v1.3/resources/views/livewire/business/module1/guest-visa/review-application.blade.php ENDPATH**/ ?>